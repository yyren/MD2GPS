...
parser.add_argument('--hpo_file_obo', type=str, default="hp.obo", help="the hpo tree in obo format")
...
query_hpo_file=args.hpo_file_patient
...
HPO_obo_file=args.hpo_file_obo
